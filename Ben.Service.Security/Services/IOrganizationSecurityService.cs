...
/// <summary>
/// Provides organisation-level permission checks and membership management used
...
public interface IOrganizationSecurityService
{
    ...
    /// <paramref name="action"/> on <paramref name="table"/> within the organisation.
    /// </summary>
    ...
    /// <summary>Returns <c>true</c> if an active membership row exists for the user in the organisation.</summary>
    /// <param name="userId">The user to check.</param>
    /// <param name="organizationId">The organisation to check membership in.</param>
    /// <param name="cancellationToken">Propagates cancellation to the database query.</param>
    ...
    /// <summary>Returns the IDs of all organisations the user is an active member of.</summary>
    /// <param name="userId">The user whose organisations are requested.</param>
    /// <param name="cancellationToken">Propagates cancellation to the database query.</param>
    Task<IReadOnlyList<Guid>> GetUserOrganizationsAsync(
        Guid userId,
        CancellationToken cancellationToken = default);

    /// <summary>Returns the user's <see cref="OrganizationMemberRole"/> within the organisation.</summary>
    /// <param name="userId">The user to look up.</param>
    /// <param name="organizationId">The organisation to check.</param>
    /// <param name="cancellationToken">Propagates cancellation to the database query.</param>
    ...
    /// <summary>Returns <c>true</c> if the user holds the <see cref="OrganizationMemberRole.Owner"/> role in the organisation.</summary>
    /// <param name="userId">The user to check.</param>
    /// <param name="organizationId">The organisation to check.</param>
    /// <param name="cancellationToken">Propagates cancellation to the database query.</param>
    ...
    /// <summary>Returns all active members of an organisation with their assigned roles.</summary>
    ...
    /// <summary>Grants a user permission to perform <paramref name="actions"/> on <paramref name="table"/> within the organisation.</summary>
    ...
    /// <summary>Revokes all access grants for the user on <paramref name="table"/> within the organisation.</summary>
    /// <param name="organizationId">Target organisation.</param>
    ...
    /// <summary>Adds a user to the organisation with the specified role, or reactivates their existing membership.</summary>
    /// <param name="organizationId">Target organisation.</param>
