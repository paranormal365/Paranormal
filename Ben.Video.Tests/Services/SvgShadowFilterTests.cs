...
public sealed class SvgShadowFilterTests
{
    ...
    {
        var result = SvgShadowFilter.Build(ColorHelper.OpaqueBlack, 3.0, 3.0, 0, 1280, 720);
    ...
    {
        var result = SvgShadowFilter.Build(ColorHelper.OpaqueBlack, 3.0, 3.0, -1.0, 1280, 720);
        Assert.Equal(string.Empty, result);
    }
    ...
    {
        var result = SvgShadowFilter.Build(ColorHelper.OpaqueBlack, 3.0, 3.0, 4.0, 1280, 720);
    ...
    {
        var result = SvgShadowFilter.Build(ColorHelper.OpaqueBlack, 0, 0, 10.0, 1280, 720);
    ...
    {
        var result = SvgShadowFilter.Build(ColorHelper.OpaqueBlack, 7.0, -2.0, 4.0, 1280, 720);
    ...
    public void Build_UsesAlphaChannel_AsFloodOpacity()
    {
        ...
        var result    = SvgShadowFilter.Build(halfAlpha, 0, 0, 4.0, 1280, 720);
