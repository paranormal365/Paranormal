...
def build_index():
    ...
    for proj, pages in NAV:
        ...
        descs = {
            ...
            "Ben.Service.RepositoryService": "Repository pattern implementation with organization security, audit logging, and geocoding services.",
            "Ben.Service.RepositoryService.Tests": "xUnit tests for repository services using EF Core InMemory provider. 119 tests.",
            "Ben.Service.Security": "Organization-level permission enforcement layer — middleware attribute, policy checks, and security enums.",
