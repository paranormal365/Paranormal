...
public class SmtpEmailServiceTests
{
    ...
    {
        var service = new SmtpEmailService(Options.Create(new SmtpOptions()));
    ...
    {
        var service = new SmtpEmailService(Options.Create(new SmtpOptions { Host = "   " }));
        Assert.False(service.IsConfigured);
    }
    ...
    {
        var service = new SmtpEmailService(Options.Create(new SmtpOptions { Host = "smtp.example.com" }));
