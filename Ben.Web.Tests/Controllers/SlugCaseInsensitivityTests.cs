...
public sealed class SlugCaseInsensitivityTests
{
    ...
    {
        var factory = await SeedAsync();
        var ctrl = new PublicEventController(factory, new Ben.Data.WebApi.Services.CmsMarkupSanitizer(), Support.SilentTourMail.Instance) { ControllerContext = Anonymous() };
