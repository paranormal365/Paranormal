...
/// <summary>Fade to white at the end of the clip (<c>fade=t=out:color=white</c>).</summary>
public sealed class FadeToWhiteEffect : IClipEffect
{
    public string EffectId    => "fade_to_white";
    public string DisplayName => "Fade to White";
        ...
        IReadOnlyDictionary<string, double> p, double clipDuration, double speed = 1.0)
    {
        ...
        return "fade=t=out:st=" + st.ToString("F3", ic) + ":d=" + d.ToString("F3", ic) + ":color=white";
    }
}
