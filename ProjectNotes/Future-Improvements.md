...
>
> Still to test: dedicated Image Editor (embedded component, not independently routed — needs a case/org context with an image file already attached to reach it), and a code-streamlining pass over anything touched this session.
