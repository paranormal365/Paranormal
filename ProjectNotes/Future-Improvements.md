...
>
> Confirmed working (SuperAdmin cross-org Cases/Investigations/Users pages on hard nav, impersonate/return-to-SuperAdmin round trip).
>
> Still to test: remaining case tabs (Files, Transfers, Reports, Research, Notes) on a real case, Case creation flow, Audio Mixer, rest of SuperAdmin journey (Roles/Audit Log/File Types/Lookup Types/Experience Taxonomy), Media Library sharing/comments/copy-on-attach, Audio file preview/edit, Image editor, and a code-streamlining pass over anything touched.
