...
namespace Ben.Web.Website.Library.SuperAdmin.Store;

/// <summary>How the store's admin screens send a chosen file to the API (storefront S1.11).</summary>
/// <remarks>
...
/// </remarks>
internal static class StoreAdminUploads
{
